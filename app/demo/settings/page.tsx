      ...
      <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
        <div className="flex items-start sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-slate-500">Демо: поведение ИИ и база знаний</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-4 sm:p-6">
            ...
            <textarea
              readOnly
              value={demoPrompt}
              className="w-full min-h-[320px] rounded-lg border border-slate-200 bg-slate-50 px-3 sm:px-4 py-3 text-sm text-slate-700 resize-none"
            />
          </div>
