...
export const demoConversations: DemoConversation[] = [
  ...
  },
  {
    ...
    status: "interested",
    last_message_at: "2026-02-11T16:03:00+05:00",
    integrations: { platform: "tg_business" },
    ...
    messages: [
      ...
      msg("d006-5", "customer", "Фергана, M, до 600 тысяч. Чтобы не мялось сильно.", "2026-02-11T16:02:00+05:00"),
      msg("d006-6", "assistant", "Отлично, поняла. Подберу варианты из более плотной ткани: рубашка + брюки и платье-рубашка в пределах <b>540 000 - 600 000 сум</b>. Через пару минут отправлю.", "2026-02-11T16:03:00+05:00"),
    ],
  },
  {
    id: "d-007",
  ...
  },
  {
    ...
    status: "waiting_call",
    last_message_at: "2026-02-11T12:59:00+05:00",
    integrations: { platform: "tg_business" },
    ...
    messages: [
      ...
      msg("d010-5", "customer", "Мне важно, чтобы не был слишком тяжелый.", "2026-02-11T12:58:00+05:00"),
      msg("d010-6", "assistant", "Поняла, учтем. Подберем облегченные модели oversize и сразу сравним по посадке в звонке.", "2026-02-11T12:59:00+05:00"),
    ],
  },
  {
    id: "d-011",
    ...
    status: "new",
    last_message_at: "2026-02-11T12:16:00+05:00",
    integrations: { platform: "instagram" },
    ...
    messages: [
      ...
      msg("d011-5", "customer", "Ищу белую блузку на офис, размер S.", "2026-02-11T12:15:00+05:00"),
      msg("d011-6", "assistant", "Отлично, подберу аккуратные офисные модели в S. Подскажите ваш бюджет, чтобы сразу отправить точные варианты.", "2026-02-11T12:16:00+05:00"),
    ],
  },
  {
    id: "d-012",
